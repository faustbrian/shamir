...
final readonly class ShareSerializer
{
    ...
    public function fromString(string $encoded): Share
    {
        ...
        if (count($parts) !== 4) {
            throw InvalidShareException::invalidFormat($encoded);
        }
     ...
     *
     * @throws InvalidShareException If required fields are missing or invalid
     *
     * @return Share Deserialized share object
     */
    public function fromArray(array $data): Share
    {
        if (
            ...
            throw InvalidShareException::missingRequiredFields();
        }
