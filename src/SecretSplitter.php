...
final readonly class SecretSplitter
{
    ...
    {
        throw_if($threshold < 2, InvalidArgumentException::class, 'Threshold must be at least 2');

        throw_if($threshold > $shares, InvalidArgumentException::class, 'Threshold cannot be greater than total shares');
